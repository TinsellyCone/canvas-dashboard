...
import { IconNotebook, IconDotsVertical, IconCheck } from "@tabler/icons-react";
...
export default function ClassCard(props) {
  ...
  return (
    <Card w={300} shadow={"lg"} radius={"md"} p={"lg"} withBorder>
      ...
      <Modal opened={opened} onClose={() => setOpened(false)} title="Edit Card" centered>
        <ColorInput
          placeholder="#ffffff"
          label="Card Color"
        ...
        <NumberInput
          ...
          min={1}
        />
        <Button mt={10} variant={"light"} onClick={() => setOpened(false)} color={"gray"}>
          Close
        </Button>
      </Modal>
    </Card>
